export default function Card() {
  return (
    <div className="flex h-56 bg-white border border-gray-200 shadow-lg rounded-lg">
      <img
      ...
      <div className="p-8 w-3/4 flex flex-col ">
        <h5 className="mt-auto block font-bold font-gudea text-3xl text-primary mb-2">
          Card Title 1 Lorem ipsum, dolor sit amet consectetur adipisicing elit.
          Similique iure ullam porro ut saepe ipsum rem?
        </h5>
